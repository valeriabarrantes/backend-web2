...
router.post('/update/:id', [verifyToken ,uploadDouble], async (req, res) => {
  try {
    ...
    marcas.fotoMarca = req.files.fotoMarca !== undefined ? '/resources/uploads/marcas/' + req.files.fotoMarca[0].filename : marcas.fotoMarca;
    ...
    marcas.fotoEmpresa = req.files.fotoEmpresa !== undefined ? '/resources/uploads/marcas/' + req.files.fotoEmpresa[0].filename : marcas.fotoEmpresa;
    marcas.save();
