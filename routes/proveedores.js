...
router.post('/add', [verifyToken, uploadSingle], async (req, res) => {
  try {
    ...
    const productos = req.body.productos instanceof Array ? req.body.productos: JSON.parse(req.body.productos);
...
router.post('/update/:id', [verifyToken, uploadSingle], async (req, res) => {
  try {
    ...
    proveedor.productos = req.body.productos instanceof Array ? req.body.productos: JSON.parse(req.body.productos);
